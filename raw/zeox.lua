...
HomeTab:AddButton({
    ...
    function()
        pcall(function() setclipboard("discord.gg/zeoxhub") end)
    end,
})
...
--  TAB: HARVEST
-- ============================================================
local HarvestTab = Window:MakeTab({ "Harvest", "trees" })
...
--  TAB: STEAL
-- ============================================================
local StealTab = Window:MakeTab({ "Steal", "users" })
...
--  TAB: SHOP
-- ============================================================
local ShopTab = Window:MakeTab({ "Shop", "store" })
...
--  TAB: DEFENSE
-- ============================================================
local DefenseTab = Window:MakeTab({ "Defense", "target" })
...
--  TAB: SELL
-- ============================================================
local SellTab = Window:MakeTab({ "Sell", "tag" })
...
--  TAB: EVENTS
-- ============================================================
local EventsTab = Window:MakeTab({ "Events", "ticket" })
...
--  TAB: EXTRA
-- ============================================================
local ExtraTab = Window:MakeTab({ "Extra", "wand" })
